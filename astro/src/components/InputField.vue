...
<template>
    <div class="flex flex-col">
        ...
        <input class="report-placeholder" :name="props.title" :placeholder="t(`forms.report.questions.${props.title}.placeholder`) as string"  :id="props.title" :type="props.type ?? 'text'" :value="props.modelValue" @input="handleChange"/>
