...
<template>
    <div class="flex flex-col">
        ...
        <span v-show="!props.isCurrency" class="mt-1 text-sm font-normal text-gray-400 italic ">{{ t(`forms.report.questions.${props.title}.subtitle`)  }}</span>
        <span v-show="props.isCurrency" class="mt-1 text-sm font-normal text-gray-400 italic ">{{ t(`forms.report.questions.${props.title}.subtitle`, { currency:  props.isCurrency })  }}</span>
    </div>
</template>