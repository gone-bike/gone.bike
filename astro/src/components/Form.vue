...
function pushToStack(page: number) {
    stack.value = [...stack.value, page]
}
function lastItemStack() {
    ...
    <div>
        ...
        <div class="flex flex-col gap-12 w-full" v-show="currentPage === 2">
            <div class="flex flex-col ml-2">
                ...
                <DatePicker lang="en" v-model="theftDateUnformated" />
            </div>
            <SelectField v-model="formValue.theft_timeframe" title="theft_timeframe"
        ...
        <div class="flex flex-col gap-12 w-full" v-show="currentPage === 5">
            <div class="flex flex-col ml-2">
                ...
                <textarea name="description" id="description" v-model="formValue.description" cols="30"
                    rows="10"></textarea>
            </div>
            <div class="flex w-full justify-between">
                <a href="#page-4"
